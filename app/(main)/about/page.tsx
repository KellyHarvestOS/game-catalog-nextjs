...
export default function AboutPage() {
  return (
    ...
    <div className="relative min-h-screen bg-slate-900 text-slate-100 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 md:py-16"> {/* z-10 чтобы быть над фоном */}
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8 lg:gap-12">
          <section className="bg-slate-800/80 backdrop-blur-sm p-6 sm:p-8 rounded-xl shadow-xl"> {/* Добавил прозрачность и блюр для фона */}
